export const en = {
  ...
  home: {
    ...
    autoGatherDuration: 'Auto gather for 8 hours',
  ...
  dailyBonus: {
    ...
    claim: 'Claim bonus',
    gemsReward: '+{n} gems',
    day7Reward: 'Day 7: x2 gather for 5 hours + 50 gems',
    streak: 'Streak: {n} days',
  },
  autoGatherSummary: {
    title: 'Auto gather finished',
    subtitle: 'Resources collected while you were away',
    ok: 'Great',
  },
  era: {
